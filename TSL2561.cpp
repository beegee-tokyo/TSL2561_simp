...
/*!
	...
	@maintainer beegee-tokyo (private) 
    ...
    v3.0 - Removed link to unified sensor library
...
boolean TSL2561::begin(TwoWire *theWire)
{
  wire = theWire;
  wire -> begin();
  return init();
...
/*!
    ...
    returns sensor reading, if value is 65536 the sensor is saturated
*/
/**************************************************************************/
uint32_t TSL2561::getEvent()
{
